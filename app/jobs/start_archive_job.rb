...
module HyraxArchivematica
  ...
  class StartArchiveJob < Hyrax::ApplicationJob
    ...
    def perform(work=nil, file_set_id=nil)
      ...
      update_archive_record ArchiveRecord::STATUS_ARCHIVE_INITIALISED
  ...
  #      end
    ...
    def latest_archive_records # Could become unwieldy
      ArchiveRecord.where(work_id:@work.id).order(created_at: :desc)
    end
